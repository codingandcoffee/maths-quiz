...
class Quiz:
    def __init__(self):
        ...
        self.start_button = Button(self.quiz_frame, text="Start", command=lambda: self.display_question(), state=DISABLED, justify=CENTER, padx=5, pady=5, font="Helvetica 12")
        ...
        self.check_button = Button(self.buttons_frame, text="Check", state=DISABLED, command=lambda: self.check(), padx=5, pady=5, font="Helvetica 12")
        self.check_button.grid(row=0, column=0)

        self.next_button = Button(self.buttons_frame, text="Next", state=DISABLED, command=lambda: self.next(), padx=5, pady=5, font="Helvetica 12")
        self.next_button.grid(row=0, column=1)

        self.quit_button = Button(self.buttons_frame, text="Quit", state=DISABLED, command=self.close_quiz, padx=5, pady=5, font="Helvetica 12")
        self.quit_button.grid(row=0, column=2)

        self.history_button = Button(self.buttons_frame, state=DISABLED, text="View History", command=lambda: self.show_results(self.quiz_history), padx=5, pady=5, font="Helvetica 12")
        self.history_button.grid(row=0, column=3)

        self.export_frame = Frame()
        self.export_frame.grid()

        self.show_export_button = Button(self.export_frame, text="Export", justify=CENTER, state=DISABLED, command=lambda: self.export(self.quiz_history), padx=100, pady=5, font="Helvetica 12")
        self.show_export_button.grid(row=1, column=0)

        self.fun_zone_button = Button(self.export_frame, text="Fun Zone", justify=CENTER, state=DISABLED, command=self.fun, padx=100, pady=5, font="Helvetica 12")
        self.fun_zone_button.grid(row=1, column=1)

        self.help_button = Button(self.export_frame, text="Help", justify=CENTER, command=self.help, padx=100, pady=5, font="Helvetica 12")
    ...
    def check(self):
        ...
        try:
            ...
            if float(answer) == self.correct_answers[self.question_number]:
...
class Fun:
    def __init__(self, partner):
        ...
        self.back_button = Button(self.fun_frame, text="Back", command=partial(self.close_fun, partner), padx=5, pady=10, font="Helvetica 12")
        self.back_button.grid()
...
class Help:
    def __init__(self, partner):
        ...
        self.help = Label(self.help_frame, font="Helvetica 10", text="Choose a quiz from the four operations. Everytime you score a 100%, you get access to Fun Zone, where you get a cool Maths Fact or Maths joke as a treat! You can complete up to four quizzes in one session.", justify=CENTER)
        self.help.grid(row=2)

        self.back_button = Button(self.help_frame, text="Back", command=partial(self.close_help, partner), font="Helvetica 12", padx=5, pady=5)
...
class Export:
    def __init__(self, partner, quiz_history):
        ...
        self.cancel_button = Button(self.save_cancel_frame, padx=5, pady=5, font="Helvetica 12", text="Cancel", command=partial(self.close_export, partner))
